...
function App() {
  ...
  const navItems = [
    { id: "navPresentacion", label: "Presentacion", href: "#descripcion-extendida" },
  ...
  return (
    <div className="grid grid-cols-10 w-full min-h-screen bg-linear-to-t 
                    ...
                    ">
      <div id="sidebar" className="col-start-2 col-span-2 mt-20 gap-12 flex 
      flex-col">
        ...
        <div id="contacto" className="flex gap-6 h-full items-end mb-20">
      ...
      <div id="main" className="col-start-5 col-span-5 mt-20 flex flex-col gap-6">
        <section id="descripcion-extendida" className="flex flex-col gap-4">
